...
software_mappings = {
    'C9300-24P': {
        'software_image': 'image/Switchs/cat9k_iosxe.17.06.01.SPA.bin',
    ...
    'C8000V': {
        'software_image': 'image/Routers/c8000v-universalk9.17.09.05a.SPA.bin',
        'software_version': '17.9.5a',
        'software_md5_checksum': '8df1fb12978e47dfa64af95edc16e22b'
    },
    'ASR1001-HX': {
        'software_image': 'image/Routers/asr1000-universalk9.17.05.01a.SPA.bin',
        'software_version': '17.05.01a',
        'software_md5_checksum': '0e4b1fc1448f8ee289634a41f75dc215'
    },
    'C9800-CL-K9': {
        'software_image': 'image/Wireless/C9800-CL-universalk9.17.09.05.SPA.bin',
        'software_version': '17.09.05',
        'software_md5_checksum': '69db6fdc7a9ef7f3719ab2ddf1bada6e'
    }

}

http_server = '10.0.0.131'
log_tofile = True
release_set = ['16.06', '17.09']
...
def main():
    try:
        ...
        if update_status:
            ...
            time.sleep(600)
            print(
                '*** EEM upgrade took more than 600 seconds to complete..Increase the sleep time by few minutes before retrying  ***\n')
            log_info(
                '*** EEM upgrade took more than 600 seconds to reload the device..Increase the sleep time by few minutes before retrying  ***\n')
        else:
        ...
        print(
            '*** Failure encountered during day 0 provisioning . Aborting ZTP script execution. Error details below   ***\n')
        log_critical(
            '*** Failure encountered during day 0 provisioning . Aborting ZTP script execution. Error details below   ***\n' + e)
        print(e)
        sys.exit(e)
